...
- ### URL Structure:
  ...
  The Twitter API follows a hierarchical URL structure, with a base URL of https://api.twitter.com.
  Twitter has two primary APIs the Twitter API v2 and the Twitter Ads API.
